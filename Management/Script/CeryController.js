...
.controller('ModelSetMealCtrl', function ($scope, $rootScope, $uibModal, $uibModalInstance, $q, $timeout, option) {
    ...
    $scope.AddMenuNum = function (menu, Class) {
        option.method.AddMenuNum(menu, Class);
    }
...
.controller('ModalAddMenuCtrl', function ($scope, $rootScope, $uibModal, $uibModalInstance, option) {
    $scope.Initialize = function () {
        var promise  =   option.method.getElements();
        promise.then(function (data) {
            $scope.OpenElements = option.method.OpenElements;
